...
module.exports = {
    title: "我们", // 博客标题
    description: "", // 博客描述,利于SEO
    keywords: "", // 关键字
    head: [
        // 注入到当前页面的 HTML <head> 中的标签
        ["link", {rel: "icon", href: "/images/love.svg"}], // 增加一个自定义的 favicon(网页标签的图标)
